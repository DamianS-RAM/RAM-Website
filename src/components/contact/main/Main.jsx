                ...
                <form action="/contact" className="flex-item font-roboto" method='POST'>
                    <div className="contact-form contact-form-item">
                        ...
                        <div className="form-element">
                            ...
                            <input type="text" name="name" id="name" placeholder="Ingrese nombre completo" autoComplete="off" autoFocus required />
                        </div>
                        <div className="form-element">
                            <div className="label">
                                Correo electrónico:
                            </div>
                            <input type="email" name="email" placeholder="Correo electrónico para contacto" required />
                        </div>
                        <div className="form-element">
                            <div className="label">
                                Teléfono:
                            </div>
                            <input type="tel" name="phone" id="phone" placeholder="Teléfono de contacto" />
                        </div>
                        <div className="form-element">
                            <div className="label">
                                Empresa:
                            </div>
                            <input type="text" name="company" placeholder="Nombre de compañía" />
                        </div>
                        <div className="form-element">
                            <div className="label">
                                Mensaje:
                            </div>
                            <textarea name="message" rows="3" placeholder="Mensaje" required></textarea>
                        </div>
                        <button type="submit" className="submit-button">Enviar
